<x-app-layout>
    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="py-5">
            ...
            <a href="{{ route('presences.exportPdf', request()->all()) }}" class="bg-green-600 text-white px-4 py-2 rounded">
                Exporter en PDF
            </a>
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-700">
                        ...
                        <td class="px-6 py-4 font-medium">
                            <span class="{{ $user->etat === 0 ? 'text-green-600' : 'text-red-600' }}">
                                {{ $user->etat === 0 ? 'Actif' : 'Inactif' }}
                            </span>
                        </td>
                        <td class="px-6 py-4">
                            <form action="{{ route('admin.toggleStatus', $user->id) }}" method="POST" class="inline">
                                ...
                                <button type="submit" 
                                    class="focus:outline-none text-white font-medium rounded-lg text-sm px-5 py-2.5 
                                        {{ $user->etat === 0 ? 'bg-red-600 hover:bg-red-800' : 'bg-green-600 hover:bg-green-800' }}">
                                    {{ $user->etat === 0 ? 'Désactiver' : 'Activer' }}
                                </button>
                            </form>
                        </td>
                    </tr>
